    ...
    //-------------- Fin para cuentas bancarias --------------------------------		
	    ...
	    //echo "<br><br>4-2 modeloSocios.php:altaSocios:resInsertar:resInsertarSociosConfirmar: ";print_r($resInsertarSociosConfirmar);
		     ...
		     $resInsertar['CODUSER'] = $arrValoresInser['usuario']['CODUSER']; 
					  ...
					  $arrMensaje['textoCabecera'] = 'Registrada solicitud de hacerte nuevo socio/a';
					  $arrMensaje['textoComentarios'] = "Hemos anotado tu solicitud para hacerte nuevo socio/a de Europa Laica. 
							...
							<br /><br />							
						 Para ser socio/a de pleno derecho tienes que abonar, si aún no lo has hecho, la cuota anual.
							<br /><br />La cuota que has elegido para año ".
							$datosSocio['ANIOCUOTA']['valorCampo']."<strong> = ".$datosSocio['IMPORTECUOTAANIOSOCIO']['valorCampo']." euros </strong>
							<br /><br />Podrás cambiar los datos relacionados con tu cuota, una vez hayas completado todo el proceso de alta 
							como socia/o de Europa Laica, entrado en la zona de socios/as en -Actualizar datos socio/a-
								<br /><br /><br />
       NOTA: Si no te llega el email para confirmar tu alta como socio/a, mira en la carpeta 'Correo no deseado' o en 'Spam'. 
							<br /><br />							
							<strong>hotmail</strong> y algunos servidores de correos, a veces rechazan correos enviados desde Europa Laica. 
							 Si no lo recibes pasado un tiempo, abre la carpeta 'Correo no deseado' y si encuentras un correo enviado por Europa Laica, 
								lo abres y lo marcas como 'Es correo deseado' y en adelante ya recibirás los correos sin problemas. 
								Si no lo encuentras puedes ponerte en contacto con \"secretaria@europalaica.com\" y te ayudaremos a resolver
								 el problema.";
						}
				 }	//else $resInsertarSociosConfirmar['codError']=='00000'					
            ...
            //echo "<br><br>2-5-2f modeloSocios.php:altaSociosConfirmada:importeCuotaAnioEL_anioActual: ";print_r($importeCuotaAnioEL_anioActual);		
	          ...
	          $resActualizarSocioConfirmar = actualizarSocioConfirmar($tablaActualizar,$codUser,$datosSocioConfirmar['socioConfirmar'],$conexionDB['conexionLink']);								
		         ...
		         //---------------------- Fin actualizarSocioConfirmar ()-------------
					      ...
					      {$resInsertar = $resActualizarSocioConfirmar;
						     ...
						     {//----------------Inicio COMMIT ------------------------------------
										  ...
										  {$resInsertar['CODUSER'] = $codUser;
												 $resInsertar['codError'] = '00000';
												 $arrMensaje['textoComentarios'] = "Acabas de confirmar tu alta como socio/a en la base de datos de Europa Laica.
													<br /><br />
													 Para ser socio/a de pleno derecho tienes que abonar, si aún no lo has hecho, 
													la cuota anual de la asociación Europa Laica. 
													<br /><br /> 
													La cuota que has elegido para el año ".$datosSocioConfirmar['ANIOCUOTA']."<strong> = ".
													$datosSocioConfirmar['IMPORTECUOTAANIOSOCIO']." euros</strong>
													<br /><br />
			            ...
			            <strong>Entrar </strong></a> y utilizar el 'usuario/a' y 'contraseña' que elegiste al registrar tus 
															datos como nuevo socio/a. Si no los recuerdas puedes recuperarlos en 
					...
					else//($resActUsuario['codError'] == '00000')
					{
						...
						{ 								
							...
							{$resConfirmarEmailPass['datosUsuario'] = $codUserDesEncriptado;//incluye ['CODUSER']=$codUserDesEncriptado, que acaso se necesite para controladorSocios.php
								...
								<br /><br /><br />Te pedirá tu usuario de Europa Laica y contraseña que acabas de elegir para poder entrar";								
...
function actualizCuotaAnioSocio($tablaAct,$campoCondiciones,$arrayDatosAct,$conexionLinkDB) 
{
		...
		//echo '<br><br>2 modeloSocios.php:actualizCuotaAnioSocio:arrayDatos: ';print_r($arrayDatos);
		...
		$resActualizarCuotaAnioSocio = actualizarTabla_ParamPosicion($tablaAct,$arrayCondiciones,$arrayDatos,$conexionLinkDB);//no es necesario //unset($arrayDatosAct['ANIOCUOTA']);
		
		//echo '<br><br>3 modeloSocios.php:actualizCuotaAnioSocio:resActualizarCuotaAnioSocio:';print_r($resActualizarCuotaAnioSocio);
