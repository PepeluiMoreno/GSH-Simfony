...
function emailAvisarCuotaSinCobrarSinCC($datosEmailCuotaSocios,$URLgastosLaicismo)
{
 ...
 $reEmailAvisarCuotaSinCobrarSinCC['codError'] = '00000';
	$remailAvisarCuotaSinCobrarSinCC['errorMensaje'] = '';																										
 ...
 $acumuladores['emailErrorEnvio'] = 0;
	...
	$body12 = $datosEmailCuotaSocios['textoEmail']['body12'];	
	$nota = $datosEmailCuotaSocios['textoEmail']['nota'];	
	
	//echo "<br><br>0-3 modeloEmail:emailAvisarDomiciliadosProxCobro:body7: ";print_r($body7);	
 ...
 foreach ($datosEmailCuotaSocios['datosEmailCuotaSocios'] as  $fila => $contenidoFila)
	{ //echo "<br><br>2a modeloEmail:emailAvisarCuotaNoSinCobrarSinCC:fila: ";print_r($fila);echo "--contenidoFila=";print_r($contenidoFila);	
   ...
   */
			...
			//echo "<br><br>2b modeloEmail:emailAvisarCuotaNoSinCobrarSinCC:fila: ";print_r($fila);echo ": linkPayPalPagoSocio=";print_r($linkPayPalPagoSocio);
		 ...
		 //echo "<br><br>3-1 modeloEmail:emailAvisarDomiciliadosProxCobro:importeCuotaDonacion: ";print_r($importeCuotaDonacion);	
			...
			$datosEnvioEmail["body"] = $body1.$contenidoFila['Apellidos_Nombre']."\n\n".$body2.$importeCuotaDonacion.$body3./*en $contenidoFila['ANIOCUOTA'].".".*/
																														"\n\n".$body4.
																														$datosEmailCuotaSocios['bancosAgrup']['TITULARCUENTASBANCOS'].																													
																														"\n".$datosEmailCuotaSocios['bancosAgrup']['banco1NombreIBAN'].
																														"\n".$datosEmailCuotaSocios['bancosAgrup']['banco2NombreIBAN'].
																														"\n".$body5.
			...
			//echo "<br><br>3-2 modeloEmail:emailAvisarCuotaNoSinCobrarSinCC:datosEnvioEmail: ";print_r($datosEnvioEmail);
