...
function menuPermisosRolesAdmin()
{
 ...
 $debugMsg = date('c')." menuPermisosRolesAdmin sid=".session_id()." host=".$_SERVER['HTTP_HOST'].
	...
	" aut=".(isset($_SESSION['vs_autentificado']) ? $_SESSION['vs_autentificado'] : 'NO').
	" rol011=".(isset($_SESSION['vs_ROL_011']) ? $_SESSION['vs_ROL_011'] : 'NO')."\n";
