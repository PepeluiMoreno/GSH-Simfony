...
2025-01-26: Cambiaron en PayPal el email de cuenta y fue necesario corregir varias funciones
email cuenta Nueva PayPal: 'tesoreria@europalaica.org'	; email	cuenta Antigua PayPal: 'tesoreria@europalaica.com'							
--------------------------------------------------------------------------------------------------*/
...
email cuenta Nueva PayPal $datosSocioPayPal['business'] = 'tesoreria@europalaica.org'	; 
email	cuenta Antigua PayPal: 'tesoreria@europalaica.com'
 ...
 /*------------- Inicio control si está MANTENIMIENTO bloquear -------------------------------*/
	...
	{if ($resBuscarModoAp['resultadoFilas'][0]['MODOAPLICACION'] == 'MANTENIMIENTO')//se bloquea el proceso de alta 
		...
		{			
						...
						{$resValidarCamposForm['CODUSER'] = $resAltaSocio['CODUSER'];  
							...
							else //$resultEnviarEmail['codError'] =='00000'
							{
								...
								/*----- Inicio  PARA PRUEBA SIN COBRAR: DESCOMENTAR -------------------------------------
									...
									$datosSocioBancosPayPal['returnPagado']='https://www.europalaica.com/usuarios_copia/index.php?controlador=cPayPal&accion=confirmadoPagoAltaSocioPayPal_Registrarse';				
									$datosSocioBancosPayPal['returnCancelado']='https://www.europalaica.com/usuarios_copia/index.php?controlador=cPayPal&accion=cancelacionPagoPayPal&resultado=cancelado';
	       ...
	       //Estos "return" vienen ya de modeloBancos.php y no es necesario descomentarlos aquí
								//$datosSocioBancosPayPal['returnPagado']='https://www.europalaica.com/usuarios/index.php?controlador=cPayPal&accion=confirmadoPagoAltaSocioPayPal_Registrarse';				
								//$datosSocioBancosPayPal['returnCancelado']='https://www.europalaica.com/usuarios/index.php?controlador=cPayPal&accion=cancelacionPagoPayPal&resultado=cancelado';
											
        //$datosSocioBancosPayPal['business'] = 'tesoreria@europalaica.com';//email cuenta antigua PayPal	no sirve		
        $datosSocioBancosPayPal['business'] = 'tesoreria@europalaica.org'; // email nueva cuenta	PayPal								
...
En esta función del controlador se puede asignar los valores:									
REAL COBRO:
email cuenta Nueva PayPal: 'tesoreria@europalaica.org'	; 
email	cuenta Antigua PayPal ya no sirve: 'tesoreria@europalaica.com'		
$datosSocioPayPal['action'] = 'https://www.paypal.com/cgi-bin/webscr'
...
//echo"<br><br>3-4 controladorSocios:confirmarAltaSocio:reEnviarEmailCoSeTe:";print_r($reEnviarEmailCoSeTe);
    ...
    //****************************************************************************************************************	
			 ...
			 /*---- Inicio Para script paypal vistas/PayPal/scriptPayPalPagoCuotaElegidaAhora.php --------
			  ...
			  $datosSocioBancosPayPal['returnPagado']='https://www.europalaica.com/usuarios_copia/index.php?controlador=cPayPal&accion=confirmarPagoPayPal';
			  $datosSocioBancosPayPal['returnCancelado']='https://www.europalaica.com/usuarios_copia/index.php?controlador=cPayPal&accion=cancelacionPagoPayPal&resultado=cancelado';	
		   $datosSocioBancosPayPal['business'] ='prueba1@europalaica.com';
				 $datosSocioBancosPayPal['action'] = 'https://www.sandbox.paypal.com/cgi-bin/webscr';
			  ----- fin PARA PRUEBA SIN COBRAR: DESCOMENTAR ------------------------------------------*/
				...
				//Estos "return" vienen ya de modeloBancos.php y no es necesario descomentarlos aquí
				//$datosSocioBancosPayPal['returnPagado']='https://www.europalaica.com/usuarios/index.php?controlador=cPayPal&accion=confirmarPagoPayPal';				
				//$datosSocioBancosPayPal['returnCancelado']='https://www.europalaica.com/usuarios/index.php?controlador=cPayPal&accion=cancelacionPagoPayPal&resultado=cancelado';
...
En esta función del controlador se puede asignar los valores:									
REAL COBRO: 
email	cuenta Antigua PayPal: 'tesoreria@europalaica.com' ya no sirve para PayPal	
email cuenta Nueva PayPal: 'tesoreria@europalaica.org'	; 	necesaria ahora	
$datosSocioPayPal['action'] = 'https://www.paypal.com/cgi-bin/webscr'
