 ...
 { header ("Location:./index.php?controlador=controladorLogin&amp;accion=validarLogin");
	...
	{			
		...
		if (isset($_POST['SiEnviar']) || isset($_POST['NoEnviar']))  
		{
			...
			{				
				...
				//echo "<br><br>2 cTesorero:emailAvisarCuotaNoCobradaSinCC:resValidarCamposFormDatosElegidos: ";print_r($resValidarCamposFormDatosElegidos);			
				...
				else //		if ($resValidarCamposFormDatosElegidos['codError']=='00000')//sin error		 
				{
					...
					{			
						...
						{					  					
								$datosMensaje['textoComentarios'] =  "No se ha envíado ningún email.<br /><br />".$resDatosEmailAvisoCuotasNoCobradas['textoComentarios'];		
						}
					...
					{ 
							...
							$datosEmailAvisoCuotasNoCobradas['bancosAgrup'] = $_POST['camposFormDatosElegidos']['bancosAgrup'];
	...
	$resEnviarEmailSocio = emailAvisarCuotaSinCobrarSinCC($datosEmailAvisoCuotasNoCobradas,$URLgastosLaicismo);//modeloEmail.php ya inclue el tratamiento de error	
		...
		{	
			...
			{
				$codAgrupBanco = '00000000';	//Cuentas de la agrupación EL Estatal e Internacional			
				...
				//echo "<br><br>5-2 cTesorero:emailAvisarCuotaNoCobradaSinCC:arrBancos: "; print_r($arrBancos);	
				...
				{					
					...
					$arrayFormDatosElegidos['bancosAgrup']['TITULARCUENTASBANCOS'] = $arrBancos['datosAgrupaciones'][$codAgrupBanco]['TITULARCUENTASBANCOS'];
					$arrayFormDatosElegidos['bancosAgrup']['banco1NombreIBAN'] = $arrBancos['datosAgrupaciones'][$codAgrupBanco]['NOMBREIBAN1'].',  IBAN: '.$arrBancos['datosAgrupaciones'][$codAgrupBanco]['CUENTAAGRUPIBAN1_PAPEL'];
					$arrayFormDatosElegidos['bancosAgrup']['banco2NombreIBAN'] = $arrBancos['datosAgrupaciones'][$codAgrupBanco]['NOMBREIBAN2'].',  IBAN: '.$arrBancos['datosAgrupaciones'][$codAgrupBanco]['CUENTAAGRUPIBAN2_PAPEL'];

					//$arrayFormDatosElegidos['agrupaciones']['valorCampo'] = $parValorComboAgrupa['lista'];//sería para que al principio salgan seleccionadas todas agrupaciones (checked marcados)
			
					//echo "<br><br>5-3 cTesorero:emailAvisarCuotaNoCobradaSinCC:arrayFormDatosElegidos: ";print_r($arrayFormDatosElegidos);
