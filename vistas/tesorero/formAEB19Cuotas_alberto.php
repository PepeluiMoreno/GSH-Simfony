...
<div id="registro">	
		<span class="error">
    <strong>PRIVACIDAD DE DATOS:</strong>  Los datos descargados en un archivo NORMA AEB19, se podrán utilizar para generar las órdenes de 
  ...
  <span class="textoAzu112Left2">
    <br /> 
		...
		- Además se pueden excluir de la lista a los/as socias/os que se dieron de alta después de una determinada fecha
			...
			<br /><br />
			- Generar a continuación el archivo con los emails a enviar a los socios/as, 
			en el menú punto I.3 del la página anterior
						<br /><br />	
					
			<strong>AVISO:</strong>Algunos navegadores pueden tener problemas para generar el archivo NORMA AEB19
			 con esta aplicación. Comprobado el funcionamiento correcto con Firefox v: 17.0.1 y Safari v:5.1.5.
				(Crome v: Versión 31.0.1650.63 y Internet Explore v: 8.0.60001 dieron algún desajuste)
	  </span>
			...
			<span class="error">
				<?php	
				 ...
				 {				
				  if ($resValidarCamposFormAEB19['codError']!=='00000')
			   {
						 echo "<strong>Debes elegir de nuevo los datos de año cuota y agrupaciones</strong>";
					 }
				 }										
				?>
			</span>
