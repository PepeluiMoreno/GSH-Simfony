...
<div id="registro">	
  ...
  <span class="textoAzu112Left2">
			<br />El contenido del email está personalizado con apellidos y nombre, cuota pendiente de pagar y enlace personalizado a PayPal para la opción de pagar con PayPal
			<br />	<br />
    <br /> 
	...
	<form method="post" action="./index.php?controlador=cTesorero&amp;accion=emailAvisarCuotaNoCobradaSinCC"> 
 	...
 	<fieldset>
			<legend><strong>Contenido email personalizado que recibirán los socios/as</strong></legend>
				<br />		
				<span class="textoAzu112Left2">		
					AVISO: En este texto del email, en el recuadro que hay escribe el enlace a la página web de laicismo.org donde se pone la información de gastos e ingresos (PREGUNTA a responsable de laicismo.org)
			...
			<fieldset> 												
				...
				<input type="text" class="sinborde" readonly 
					...
					value="<?php echo 'Titular cuentas: '?>"
					size="13"
					maxlength="255"
					/>			
					<input type="text" class="sinborde" readonly 
					name="camposFormDatosElegidos[bancosAgrup][TITULARCUENTASBANCOS]"
					value="<?php echo $camposFormDatosElegidos['bancosAgrup']['TITULARCUENTASBANCOS'];	?>"
					size="60"
					maxlength="255"
					/>			
				<br />							
					<input type="text" class="sinborde" readonly 
					name="camposFormDatosElegidos[bancosAgrup][banco1NombreIBAN]"
					value="<?php if (isset($camposFormDatosElegidos['bancosAgrup']['banco1NombreIBAN']) && !empty ($camposFormDatosElegidos['bancosAgrup']['banco1NombreIBAN']) )
					{ echo $camposFormDatosElegidos['bancosAgrup']['banco1NombreIBAN'];
					}			
					?>"
					size="100"
					maxlength="255"
				...
				<br />		
					<input type="text" class="sinborde" readonly 
					name="camposFormDatosElegidos[bancosAgrup][banco2NombreIBAN]"
					value="<?php if (isset($camposFormDatosElegidos['bancosAgrup']['banco2NombreIBAN']) && !empty ($camposFormDatosElegidos['bancosAgrup']['banco2NombreIBAN']) )
					{ echo $camposFormDatosElegidos['bancosAgrup']['banco2NombreIBAN'];
					}						
					?>"
					size="100"
					maxlength="255"
...
Para ello debes entrar en el -ÁREA DE SOCI@S- desde la página web de www.laicismo.org , o bien haciendo clic en el siguiente enlace: https://www.europalaica.org/usuarios
</textarea>					
					...
					<br />
				<textarea type="text" class="sinborde" readonly  name="camposFormDatosElegidos[textoEmail][body12]" rows="15" cols="180" wrap="hard"> 
					<?php echo "
...
Si quieres más información haz clic en el siguiente enlace: https://www.europalaica.com/usuarios/index.php?controlador=cEnlacesPie&accion=privacidad"		
	?>
					</textarea> 
				</fieldset>
