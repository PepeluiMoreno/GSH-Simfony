<!--***************************** Inicio vCuerpoInfTotalesCuotasAnioAgrup.php ***************
FICHERO: vCuerpoInfTotalesCuotasAnioAgrup.php
Agustín : modificación 2017-01-31
PROYECTO: EL
VERSION: PHP 5.2.3
DESCRIPCION: Contiene el texto de la  información del significado de las columns del
             formulario formTotalesCuotasAnioAgrup.php
OBSERVACIONES:Se le llama desde vInfTotalesCuotasAnioAgrupInc.php
*******************************************************************************-->
<div class="content0">
  ...
  <!--************************ Inicio Cuerpo central ************************-->
	<div class="blank">
		<h3 align="center">
	  	INFORMACIÓN SOBRE LAS COLUMNAS DE "TOTALES PAGOS CUOTAS POR AÑO Y AGRUPACIONES"
				<br /><br />
		</h3>
	 <span class="textoAzul9Left">Muestra los pagos realizados en un año a las agrupaciones por los socios/as.
		 Incluye también las bajas, hasta el año 
 ...
 <b>Agupación:</b> Agrupación a la que se refiere el pago de las cuotas
	</li><br />
 ...
 <b>Gastos cobro cuotas €:</b> La suma de las gastos generados por el cobro de las cuotas de los socio/as: pago mediante PayPal (se anotan por cada pago) y otros gastos que hubiese anotado el tesorero (domiciliaciones es global, devoluciones individual).
	...
	<li class="textoNegro8Left">
	<b>TOTALES INGRESOS:</b>Esta cifra es la suma total de ingresos por cuotas y no están descontados los gastos de cobro de cuotas.
...
Se obtiene: Cuotas pagadas + Pagos de Exentos + Pagado parte + Donado en la cuota. Es decir la suma de las columnas (9+16+18+20).
	<br /><br />NOTA: En la tabla se muestran números enteros (sin decimales por problemas de espacio),
	 y si se comprueba sumando manualmente para obtener los TOTALES CUOTAS PAGADAS, en algún caso podría no coincidir (diferencia inferior a 5 euros), 
...
<!-- ******************************* Fin Cuerpo vCuerpoInfTotalesCuotasAnioAgrup.php ************* -->