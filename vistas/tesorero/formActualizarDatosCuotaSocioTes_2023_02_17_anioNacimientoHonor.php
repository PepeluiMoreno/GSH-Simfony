  ...
  <!-- ****************** Fin Campos hidden ***************************************************** -->
    ...
    <br />			
			 <!-- ************************** Inicio mostrar cuotas año actual ***************** -->			
				<?php 
					...
					{echo "<span class='mostrar'>Devolución recibo de pago. Puedes contactar con Tesorería de Europa Laica</span>";
					}				
	    ...
	    /><label>Parado/a o dificultades enconómicas&nbsp;(mínimo <?php echo ceil($datSocio['campoActualizar']['datosCuotasEL']['IMPORTECUOTAANIOELParado']).' €)'; ?></label>	
	           ...
	           {  echo " checked";}
	           ?>
	    /><label>Honorario&nbsp;(mínimo <?php echo ceil($datSocio['campoActualizar']['datosCuotasEL']['IMPORTECUOTAANIOELHonorario']).' € obligatorio)'; ?></label>										
	...
	<fieldset>
	  <legend>Ordenar el cobro de la cuota en la cuenta del socio/a para la próxima remesa</legend>
		 <p>
				<label>*Incluir en la próxima lista de órdenes de cobro a los bancos (aún no se puede con Honorarios ni con c. extranjeras) del año 			
