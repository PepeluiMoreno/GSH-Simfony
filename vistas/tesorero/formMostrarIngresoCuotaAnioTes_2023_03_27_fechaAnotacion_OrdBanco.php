      ...
      <?php 
       ...
       ?>					
			...
			<label>Tipo cuota</label> 
					<span class="mostrar">
      <?php 
							  echo $datSocio['datosFormSocio']['CODCUOTA']['valorCampo'];   
       ?>					
					</span>						
		</p>	
 <!--</fieldset> -->
	...
	<br />			
     ...
     <tr bgcolor="#CCCCCC">
      ...
      <th  class="textoAzul8C">Ingreso</th>  
						<th  class="textoAzul8C">Gastos</th>  						
      ...
      <th  class="textoAzul8C">Modo pago</th>
						<th  class="textoAzul8C">Ordenar cobro banco</th>
     ...
     <?php 
      ...
      //foreach ($datCuotas as $ordinal => $fila)
   	  ...
   	  {echo ("<tr height='25' bgcolor='#eeeded'>"); 
							...
							echo ("<td class='textoAzul7C' style='word-wrap: break-word'>".$fila['NOMAGRUPACION']['valorCampo']."</td>");
       ...
       if ($saldo < 0)							
						 {echo ("<td class='textoRojo7Right'>".$saldo."</td>");
							}
						 else 
						 {echo ("<td class='textoAzul7R'>".$saldo."</td>");
							}
							if ($fila['ESTADOCUOTA']['valorCampo'] !== 'ABONADA' && $fila['ESTADOCUOTA']['valorCampo'] !== 'EXENTO')
						 { echo ("<td class='textoRojo7Center' style='word-wrap: break-word'>".$fila['ESTADOCUOTA']['valorCampo']."</td>");	
							}
						 else 
						 { echo ("<td class='textoAzul7C' style='word-wrap: break-word'>".$fila['ESTADOCUOTA']['valorCampo']."</td>");	
							}							
	
				   if (isset($fila['MODOINGRESO']['valorCampo']) && !empty($fila['MODOINGRESO']['valorCampo']))
       { echo ("<td class='textoAzul7C' style='word-wrap: break-word'>".$fila['MODOINGRESO']['valorCampo']."</td>");
							}
						 else
							{ echo ("<td class='textoAzul7L'style='word-wrap: break-word'>"."&nbsp;"."</td>");
							}	
				   if (isset($fila['ORDENARCOBROBANCO']['valorCampo']) && !empty($fila['ORDENARCOBROBANCO']['valorCampo']))
       { echo ("<td class='textoAzul7C' style='word-wrap: break-word'>".$fila['ORDENARCOBROBANCO']['valorCampo']."</td>");
							}
						 else
							{ echo ("<td class='textoAzul7L'style='word-wrap: break-word'>"."&nbsp;"."</td>");
							}								
