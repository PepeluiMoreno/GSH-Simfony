...
<div id="registro">	
 ...
 <br /><br />
  ...
  <span class="textoAzu112Left2">
			<br />El contenido del email está personalizado con apellidos y nombre, cuenta IBAN del socio/a y la cuota que se va a cobrar en su banco. Son leídos de la base de datos.
			<br />	<br />
    <br /> 
	  ...
	  <fieldset>
				...
				<legend><strong>Contenido del email personalizado que recibirán los socios/as</strong></legend>
					<br />
					<span class="textoAzu112Left2">		
						En el primer recuadro, tienes que escribir un texto con la fecha prevista de envío al banco (mejor 3 días antes para las posibles modificaciones). Por ejemplo: - 3 de marzo de <?php echo date("Y");?>
						<br /><br />En el segundo recuadro escribe el enlace a la página web de laicismo.org donde se está la información de gastos e ingresos (PREGUNTA al responsable de laicismo.org). 
						Si no cambia es la URL: https://laicismo.org/cuentas-de-europa-laica-transparencia-e-informacion/
						<br /><br />El tercer recuadro, que es opcional, puedes escribir el tel. de tesorería y otra información.
					</span>	
      ...
      <br /><br />					
					...
					<!-- text area-->	
		   <textarea type="text" class="sinborde" readonly name="camposFormDatosElegidos[textoEmail][body6]" rows="3" cols="180" wrap="hard"> 
Para corregirla puedes entrar en el -ÁREA DE SOCI@S- desde la página web https://laicismo.org o bien haciendo clic en el siguiente enlace: 
					</textarea> 
		   ...
		   <textarea type="text" class="sinborde" readonly name="camposFormDatosElegidos[textoEmail][body8]" rows="7" cols="180" wrap="hard"> 
...
- Las actividades de las personas de la junta directiva y otros órganos de coordinación son totalmente voluntarias, no percibiendo pagos de salarios u otras compensaciones económicas.
					...
					<input type="text" class="sinborde" readonly 
						name="camposFormDatosElegidos[textoEmail][body9]"
					...
					<span class="textoGris8Left1"><i>Opcional: Escribir nota de tesorería con tel. contacto para dudas y otra información que se añadiría en el email en esta posición</i></span>
					      ...
					      <br />
						<!-- text area-->	
		   <textarea type="text" class="sinborde" readonly  name="camposFormDatosElegidos[textoEmail][body10]" rows="11" cols="180" wrap="hard"> 
		    <?php echo "
