  ...
  <br />	
   ...
   <?php //echo "<label><br />datosSocio['datosFormCuotaSocio': ";  print_r($datosSocio['datosFormCuotaSocio']);
         //echo "<label><br><br>datSocio: "; print_r($datosSocio);echo "</label><br>";
				...
				/*--------- Inicio Información de la cuota del año actual (Y) ----------------------------------------------------*/						
				echo "<label>Cuota pagada por el socio/a en <strong>".$datosSocio['datosFormCuotaSocio'][date('Y')]['ANIOCUOTA']['valorCampo']."</strong></label>"; 
				...
				echo "<br />";			
   	//echo "<label>Mínimo </label>";	echo "<span class='mostrar'>".$datosSocio['datosFormCuotaSocio'][date('Y')]['IMPORTECUOTAANIOEL']['valorCampo']."</span><br />";															
				...
				{ 
				  echo "<span class='mostrar'>Devolución de la orden de pago. Contacta con Tesorería de Europa Laica</span>";
				}																			
     ...
     {	echo "<label>Cuota Reducida tipo </label>";
					...
					elseif ($datosSocio['datosFormCuotaSocio'][date('Y')]['CODCUOTA']['valorCampo'] == 'Honorario')
				 {
						echo "<label>Cuota tipo </label>";
						echo "<span class='mostrar'>".$datosSocio['datosFormCuotaSocio'][date('Y')]['CODCUOTA']['valorCampo']."</span><br />";					
						//if ($datosSocio['datosFormCuotaSocio'][date('Y')]['IMPORTECUOTAANIOSOCIO']['valorCampo'] > 0 )
						if ($datosSocio['datosFormCuotaSocio'][date('Y')]['IMPORTECUOTAANIOSOCIO']['valorCampo'] == 0 )	
				 	{	
						 echo "<label>Tienes una Cuota tipo <strong>HONORARIO</strong> y no tienes que pagar ninguna cuota, pero si quieres puedes domiciliar el pago de una cuota voluntaria</label>";
						}
					}			
				}
				/*--------- Fin Información de la cuota del año actual (Y) -------------------------------------------------------*/					
	
    /*--------- Inicio Información de la cuota para nuevo próximo  (Y+1) (solo cuando anterior (Y) ya está pagado) ---*/							
     ...
     {	echo "<label>Cuota Reducida tipo </label>";
      	...
      	echo "<span class='mostrar'>".$datosSocio['datosFormCuotaSocio'][date('Y')+1]['CODCUOTA']['valorCampo']."</span>";						
				 ...
				 {	//echo "<label>Cuota tipo <strong>Honorario</strong> estás exento de pagar cuota </label>";
					 	...
					 	echo "<label>Cuota tipo </label>";
				 		echo "<span class='mostrar'>".$datosSocio['datosFormCuotaSocio'][date('Y')+1]['CODCUOTA']['valorCampo']."</span>";								
							if ($datosSocio['datosFormCuotaSocio'][date('Y')+1]['IMPORTECUOTAANIOSOCIO']['valorCampo'] == 0 )
							{	
								echo "<br /><label>Tienes una Cuota tipo <strong>HONORARIO</strong> y no tienes que pagar ninguna cuota, pero si quieres puedes domiciliar el pago de una cuota voluntaria</label>";
							}
					}	
				}				
		 	/*--------- Fin Información de la cuota para nuevo próximo  (Y+1) (solo cuando anterior (Y) ya está pagado) ------*/			
				
    echo "<br /><label>Puedes modificar tu cuota en la opción <strong>-Actualizar datos socio/a</strong></label>";	
   ?>	
	 	<!-- *********************** Fin Datos de Cuotas  *************************************************************** -->
