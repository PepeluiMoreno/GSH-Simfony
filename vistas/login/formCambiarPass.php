...
OBSERVACIONES:Es incluida desde "vCuerpoCambiarUser.php"
------------------------------------------------------------------------------- */
?>
<div id="registro">
    <br /> 
    <span class="textoAzu112Left2">
        ...
        para entrar en la aplicación de socios/as de Europa Laica 
    </span>
    <br /><br /><br /><br /> 
    <form name="actualizarSocio" method="post"
          action="./index.php?controlador=controladorLogin&amp;accion=cambiarPassUser">

        <!--****************** Inicio Datos de contraseña ************-->
        <fieldset>
            <legend><strong>Contraseña para entrar en la "Zona privada de Soci@s" de Europa Laica</strong></legend>
            <p>
