<?php
/*-----------------------------------------------------------------------------
FICHERO: formEliminarSocioPorGestor.php

VERSION: PHP 5.6.4
DESCRIPCION: Es el formulario para eliminar los datos de de un socio, 
             previamente muestra algunos campos de datos

OBSERVACIONES:Es incluida desde "vCuerpoEliminarSocioPorGestor.php"
             									

2020-06-14: Modifico para incluir CODAGRUPACION, Modifico para validar 
OBSERVACIONES, y correspondiente mensaje de error
2018-10-06: Añado todo lo referente a eliminar archivo con la firma del socio y mostrar aquí
2017-04-16: añadida para rol tesorería la acción "baja": eliminarSocioTes()
 ...
 <!--<div id="formLinea">-->
	 ...
	 <!-- El siguiente "if" sirve para retornar el form a la función correspondiente al rol de gestor 
		...
		<?php
			...
			{ $accionForm ="./index.php?controlador=cCoordinador&amp;accion=eliminarSocioCoord";
			}
			elseif ($tituloSeccion == "Presidencia, Vice. y Secretaría")
			{ $accionForm ="./index.php?controlador=cPresidente&amp;accion=eliminarSocioPres";
			}
			elseif ($tituloSeccion == "Tesorería")
			{ $accionForm ="./index.php?controlador=cTesorero&amp;accion=eliminarSocioTes";
			}
	 ?>	

  <form method="post" class="linea" action="<?php echo $accionForm?>" onSubmit="return confirm('¿Dar de baja al socio/a')">			
 ...
 <span class="textoAzu112Left2">
  ...
  <br /><br />
	 ...
	 <!-- ******************* Fin Datos de SOCIO ******************************** -->	
		...
		<br />
 <input type="submit" name="SiEliminar" value="Baja socio/a" class="enviar">			
	<input type="submit" name="SiEliminarFallecimiento" value="Baja socio/a por fallecimiento y guardar su nombre" class="enviar">
	&nbsp;&nbsp;&nbsp;&nbsp;
	<input type="submit" name="NoEliminar" value="No dar baja socio/a" class="enviar">
			
 </form>
<!--		
  <form method="post" class="linea" action="./index.php?controlador=cPresidente&amp;accion=eliminarSocioPres">		
   <input type="submit" name="SiEliminarFallecimeinto" value="Eliminar socio por fallecimiento" class="enviar">
  </form>					
-->
  <!--
