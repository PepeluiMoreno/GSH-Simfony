<?php
/*--------------------------------------------------------------------------------------------------
FICHERO: formAltaSocioPorGestor.php
VERSION: PHP 7.3.21
...
LLAMADA: 
vAltaSocioPorGestorInc.php que a su vez es llamado desde controladores/libs/altaSocioPorGestor.php
y a su vez llamada desde: cCoordinador.php:altaSocioPorGestorCoord(),
cPresidente.php:altaSocioPorGestorPres(), cTesorero.php:altaSocioPorGestorTes()					
													
OBSERVACIONES: 
2020-09-10: hago modificaciones para que este formulario pueda ser común para las altas de socios 
por los distintos tipos de gestores con unos if que selecciones según sea el valor del 
parámetro: $tituloSeccion == "Coordinador/a", == "Presidencia, Vice. y Secretaría", == "Tesorería"

Estos if afectan a  <!-- <form ... action="
--------------------------------------------------------------------------------------------------*/
...
-->
 ...
 <div id="registro"><!-- ******** Inicio <div id="registro"> Incluye todo ********** -->
   ...
   <br />			
	 ...
	 <!-- El siguiente "if" sirve para retornar el form a la función correspondiente al rol de gestor 
		     que realizar el alta y que llama a este formulario compartido por los gestores con rol de:
							"Coordinación, "Presidencia, Vice. y Secretaría" y "Tesorería".	
		<?php
			if ($tituloSeccion == "Coordinador/a")//if ($tituloSeccion == "Presidencia, Vice. y Secretaría" || $tituloSeccion == "Tesorería")	
			{ $accionForm ="./index.php?controlador=cCoordinador&amp;accion=altaSocioPorGestorCoord";
			}
			elseif ($tituloSeccion == "Presidencia, Vice. y Secretaría")
			{ $accionForm ="./index.php?controlador=cPresidente&amp;accion=altaSocioPorGestorPres";
			}
			elseif ($tituloSeccion == "Tesorería")
			{ $accionForm ="./index.php?controlador=cTesorero&amp;accion=altaSocioPorGestorTes";
			}
	?>
 <!-- <form name="registrarSocio" method="post" action="./index.php?controlador=cPresidente&amp;accion=altaSocioPorGestorPres"
            enctype="multipart/form-data">
	-->
	<form name="registrarSocio" method="post"  action="<?php echo $accionForm?>" enctype="multipart/form-data">	
  <br />		
  ...
  <fieldset>							
   ...
   <!--  **************** Inicio  Subir al servidor el Archivo de alta ******************* -->	
     ...
     <p>
							...
							<input type="hidden" name="ficheroAltaSocioFirmado[MaxArchivoSize]" value="2097152" /><!-- Tamaño máximo en bytes =2MB podría venir desde cCoordinador.php:altaSocioPorGestorCoord() -->
							<input type="hidden" name="ficheroAltaSocioFirmado[directorioSubir]" value="/../upload/FIRMAS_ALTAS_SOCIOS_GESTOR" /><!--Directorio relativo donde se guardarán los archivos de firmas podría venir desde cCoordinador.php:altaSocioPorGestorCoord()-->	

							<?php	$cadExtensionesPermitidas = "doc,docx,odt,odi,gif,jpg,jpeg,pdf"; ?>		<!-- podría venir desde cCoordinador.php,cPresidende.php,cTesorero.php:altaSocioPorGestorgggg() -->									
							...
							<br />			
							<input type="file" name="ficheroAltaSocioFirmado" size="80" />	
