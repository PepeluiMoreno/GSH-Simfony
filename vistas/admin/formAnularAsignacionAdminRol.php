<?php
/*----------------------------------------------------------------------------------------------------														
FICHERO: formAnularAsignacionAdminRol.php
VERSION: PHP 7.3.21
...
LLAMADA: vistas/admin/vCuerpovAnularAsignacionAdminRol.php
y previamente desde cAdmin.php:asignarAdministracionRolBuscar()

LLAMA: cAdmin.php:eliminarAsignacionAdministracionRol()
...
<div id="registro">
 ...
 <span class="textoAzu112Left2">
	  Este socio/a tiene asignado el rol de Administración
  </span>
  <br /> <br />
		
 <div id="formLinea">
		
		<!-- ******************* Inicio Form para eliminar rol de Administración ************* -->

  <form method="post" class="linea" action="./index.php?controlador=cAdmin&amp;accion=eliminarAsignacionAdministracionRol"
	       onSubmit="return confirm('¿Eliminar asignación del rol Administración?')">							
  ...
  <input type="submit" name="SiEliminar" value="Eliminar asignación de rol Administración" class="enviar">				

 </form>
	<!-- ******************* Fin Form para eliminar rol de Administración ****************** -->
