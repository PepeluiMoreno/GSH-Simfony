<?php
/*----------------------------------------------------------------------------------------------------														
FICHERO: formAnularAsignacionMantenimientoRol.php
VERSION: PHP 7.3.21
...
LLAMADA: vistas/admin/vCuerpovAnularAsignacionMantenimientoRol.php
y previamente desde cAdmin.php:asignarMantenimientoRolBuscar()

LLAMA: cAdmin.php:eliminarAsignacionMantenimientoRol()
...
<div id="registro">
 ...
 <span class="textoAzu112Left2">
	  Este socio/a tiene asignado el rol de Mantenimiento
  </span>
  <br /> <br />
		
 <div id="formLinea">
		
		<!-- ******************* Inicio Form para eliminar rol de Mantenimiento ************* -->

  <form method="post" class="linea" action="./index.php?controlador=cAdmin&amp;accion=eliminarAsignacionMantenimientoRol"
	       onSubmit="return confirm('¿Eliminar asignación del rol Mantenimiento?')">							
  ...
  <input type="submit" name="SiEliminar" value="Eliminar asignación de rol Mantenimiento" class="enviar">				

 </form>
	<!-- ******************* Fin Form para eliminar rol de Mantenimiento ****************** -->
