<?php
/*--------------------------------------------------------------------------------------------------
FICHERO: formMostrarListaAdminRol.php
PROYECTO: EL
VERSION: PHP 7.3.21
...
LLAMADA: vistas/admin/vCuerpoMostrarListaAdminRol.php
...
<div id="registro">
 ...
 <br />
	...
	- En la lista está incluidas socias/os con  el rol de Administración
	</span>
	<br /> 	<br /> 
   ...
   <tr>
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#99CCFF">
     ...
     <?php 				
				 ...
				 $items = $datosSociosAdministracionRol['resultadoFilas'];
