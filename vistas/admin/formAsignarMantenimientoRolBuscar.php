<?php
/*--------------------------------------------------------------------------------------------------
FICHERO: formAsignarMantenimientoRolBuscar.php
...
Según la situación se podrá después se podrá asignar/eliminar rol de Mantenimiento

Tiene tres botones para "Buscar por apellidos", "Buscar por email", y para "Cancelar"

LLAMADA: vistas/admin/vCuerpoAsignarMantenimientoRolBuscar.php
...
<br />	
				 ...
				 <form method="post" action="./index.php?controlador=cAdmin&accion=mostrarListaMantenimientoRol">
					      <input type="submit" name="mostrarListaMantenimientoRol" value="Lista de socios/as con rol Mantenimiento">
	    </form>					
			
    </div>
<br />				
	<span class="textoAzul8Left">
 El Administrador/a, pueden asignar o anular el rol de Mantenimiento a un socios/a de EL				
<br /><br />	
Primero hay que buscar al socio/a para después hacer la operación de asignar-anular el rol de Mantenimiento
	 			<br /><br />
 ...
 <!-- ********************* Inicio  mensaje error *************** -->
  <br /><br /><br />
	...
	<!-- *************** Inicio form búsqueda por APE1, APE2 ************* -->	
		<form method="post" action="./index.php?controlador=cAdmin&amp;accion=asignarMantenimientoRolBuscar">
	  <fieldset>
		...
		<!--			 <input type="submit" name="NoAsignar" value="No asignar Mantenimiento" class="enviar"> -->
	 </fieldset>	
 </form>
 ...
 <!-- *************** Inicio form búsqueda 'EMAIL' ******************** -->	
	  ...
	  <fieldset>
		...
		<!--			 <input type="submit" name="NoAsignar" value="No asignar rol Mantenimiento" class="enviar"> -->					
	 </fieldset>	
 </form>					
