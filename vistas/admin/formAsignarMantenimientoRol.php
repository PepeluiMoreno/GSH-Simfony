<?php
/*--------------------------------------------------------------------------------------------------
FICHERO: formAsignarMantenimientoRol.php
PROYECTO: EL
VERSION: PHP 7.3.21
...
LLAMADA: vistas/admin/vCuerpoAsignarMantenimientoRol.php
y previamente desde  cAdmin.php:asignarMantenimientoRolBuscar(), asignarMantenimientoRol()
...
<div id="registro">
 ...
 <div id="formLinea">
  ...
  <form method="post" class="linea" action="./index.php?controlador=cAdmin&amp;accion=asignarMantenimientoRol"	
			     onSubmit="return confirm('¿Asignar rol de Mantenimiento?')">			
...
?></textarea> 			 
	 ...
	 <!-- ******************* Fin Datos de identificación Socio ************** --> 	 		
	  ...
	  <input type="submit" name="SiAsignar" value="Asignar rol de Mantenimiento" class="enviar">	
  </form>

  <form method="post" class="linea" action="./index.php?controlador=cAdmin&amp;accion=asignarMantenimientoRol">		
   <input type="submit" name="NoAsignar" value="Cancelar asignar rol de Mantenimiento" class="enviar">
  </form>					
