<?php
/*--------------------------------------------------------------------------------------------------
FICHERO: formMostrarListaMantenimientoRol.php
PROYECTO: EL
VERSION: PHP 7.3.21
...
modelos/modeloPresCoord.php:buscarDatosGestoresRoles($codRol ="0")

LLAMADA: vistas/admin/vCuerpoMostrarListaMantenimientoRol.php
...
<div id="registro">
 ...
 <br />
	...
	- En la lista está incluidas socias/os con  el rol de Mantenimiento
	</span>
	<br /> 	<br /> 
   ...
   <tr>
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#99CCFF">
     ...
     <?php 				
				 ...
				 $items = $datosSociosMantenimientoRol['resultadoFilas'];
