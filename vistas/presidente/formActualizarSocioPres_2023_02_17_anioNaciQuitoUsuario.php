...
<div id="registro">
 ...
 <br /><br />
 <form name="actualizarSocio" method="post" class="linea" action="./index.php?controlador=cPresidente&amp;accion=actualizarSocioPres">
			...
			********************************************************************************************* -->	   
			...
			<input type="hidden"	id="codUser" name="campoActualizar[datosFormUsuario][CODUSER]"
									 value='<?php if (isset($datSocio['campoActualizar']['datosFormUsuario']['CODUSER']['valorCampo']))
																...
																?>'
			/>			
			<input type="hidden"	id="codUser" name="campoActualizar[datosFormUsuario][USUARIO]"
   ...
   <br />	
	    ...
	    <!--			<br />			
			 <label>Puedo colaborar en </label>		Ya no se utiliza
					<?php	  	
						/*$parValorColabora=array("NO-ELIGE"=>"Elegir opción","secretaria"=>"Tareas de secretaría","prensa"=>"Contactos con la prensa",
				...
				<label>*Tipo cuota</label>	
					...
					<input type="radio"
							...
							<?php if ($datSocio['campoActualizar']['datosFormSocio']['CODCUOTA']['valorCampo']=='Honorario')
												{  echo " checked";}
												?>
					/><label>Honorario&nbsp;( <?php echo ceil($datSocio['campoActualizar']['datosCuotasEL']['IMPORTECUOTAANIOELHonorario']).' € obligatorio)'; ?></label>										
					<br /> 
			...
			<p>
			 <!-- ********************** Incio cuenta bancaria  ************************************ -->		
				...
				<span class="comentario11">
					...
					<br /><br />
					- Si la cuenta bancaria del socio/a no pertenece a un banco con sucursales en España
					es más fácil pagar mediante PayPal (con tarjeta de crédito o con una cuenta de PayPal). También disponible en Gestión de Soci@s, -Pagar cuota anual 		
					<br /><br />
