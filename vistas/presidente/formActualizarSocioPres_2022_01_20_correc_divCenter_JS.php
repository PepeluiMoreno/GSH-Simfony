<?php
/*---------------------------------------------------------------------------------------------------
FICHERO: formActualizarSocioPres.php
VERSION: PHP 7.3.21
...
LLAMADA: vistas/presidente/vCuerpoActualizarSocioPres.php
...
<div id="registro">
 ...
 <form name="actualizarSocio" method="post" class="linea"
    action="./index.php?controlador=cPresidente&amp;accion=actualizarSocioPres">
  ...
  <!-- ****************** Fin Campos hidden ***************************************************** -->
	 ...
	 <fieldset>
	  <legend><b>Usuario/a para entrar en la "Zona privada de soci@s"</b></legend>
		 <p>			
		  <span class="comentario11">
	 ...
	 <fieldset>
	 <legend><strong>Datos de las cuotas del socio/a</strong></legend>
			<p>
    ...
    <br /><br />
			 ...
			 <!-- ******************* Inicio actualizar importeCuotaSocio  ********************* -->
				...
				<span class="comentario11">Ahora puedes modificar la cantidad elegida como cuota por el socio/a (a petición del mismo/a)
																														<br />
																															Si en el presente año ya estuviese abonada la cuota, 
																															se anotará como nueva cuota para el próximo año. 
																															<br />Si el socio/a así te lo ha comunicado, 
				...
				<label>Tipo cuota</label>	
					...
					<input type="radio"
							...
							<?php if ($datSocio['campoActualizar']['datosFormSocio']['CODCUOTA']['valorCampo']=='Honorario')
												{  echo " checked";}
												?>
					/><label>Honorario&nbsp;(mínimo <?php echo $datSocio['campoActualizar']['datosCuotasEL']['IMPORTECUOTAANIOELHonorario'].')'; ?></label>										
					<br /> 
					...
					<span class="comentario11">
						...
						puedes elegir la correspondiente cuota reducida hasta que cambie su situación. 		
					</span>	
				 <br /><br />			
	 ...
	 <fieldset>	  
		<legend><strong>Modificar datos bancarios de domiciliación pago cuotas</strong></legend>
			<p>
			 <!-- ********************** Incio cuenta bancaria  ************************************ -->		
				<span class="comentario11">
				...
				<label>Cuenta <strong>IBAN</strong> (dos letras de país + número sin espacios)</label> 
					...
					<!-- Inicio Antiguo, lo dejo por si más adelente se quisiera activar de nuevo ******************	
					<span class="comentario11">El IBAN es obligatorio para "domiciliaciones y transferencias", 
						a partir del 1 de febrero 2014, en los 28 estados de la Unión Europea (mas Islandia, Liechtenstein, Noruega, Mónaco, San Marino  y Suiza), 
						pertenecientes a la zona SEPA (Zona única de pagos en euros).
					</span>			
					<br /><br />

					<span class="comentario11">Si la cuenta bancaria está fuera del ámbito IBAN, puedes escribir aquí su cuenta
					</span>
					<br />		
					...
					<span class="error">
						<?php
							/*if (isset($datSocio['campoActualizar']['datosFormSocio']['CUENTANOIBAN']['errorMensaje']))
									{echo $datSocio['campoActualizar']['datosFormSocio']['CUENTANOIBAN']['errorMensaje'];}
							*/			
						?>
					</span>
							** Fin Antiguo, lo dejo por si más adelente se quisiera activar de nuevo *****************	-->	
				 <br /><br />	
				<span class="comentario11">
					...
					<br /><br />
						...
						lo tendrá que hacer por alguno de los otros procedimientos que antes te hemos indicado (excepto si ha domiciliado el pago ahora o al darse de alta).	
					</span>	
				 <br />		
  ...
  <!-- ********************** Inicio Agrupación territorial ************************** -->	
	 ...
	 <p>		
	  <label>*Agrupación territorial del socio/a</label>
	   <?php    
			 //function comboLista($parValor,$identificadorCampo,$valorPrevio,$descPrevio,$valorInicial,$descInicial)
	 ...
	 <!-- ***** Inicio ['COMENTARIOSOCIO'] y [OBSERVACIONES] para tabla MIEMBRO ********* -->
	  ...
	  <legend><b>Comentarios del socio /a al darse de alta (visible para gestores/as)</b></legend>
		 <p>
				...
				class="textoAzul8Left" name="campoActualizar[datosFormMiembro][COMENTARIOSOCIO]" rows="3" cols="80"><?php 
	 ...
	 <fieldset>
	  <legend><b>Observaciones del gestor de socios /as</b></legend>
		 <p>
				...
				class="textoAzul8Left" name="campoActualizar[datosFormMiembro][OBSERVACIONES]" rows="3" cols="80"><?php 
