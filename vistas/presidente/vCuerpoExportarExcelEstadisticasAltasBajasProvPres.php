<?php
/**************** Inicio vCuerpoExportarExcelEstadisticasAltasBajasProvPres.php ********************
FICHERO: vCuerpoExportarExcelEstadisticasAltasBajasProvPres.php
VERSION: PHP 7.3.21
...
LLAMADA: vistas/presidente/vExportarExcelEstadisticasAltasBajasProvPres.php
y previamente desde  cPresidente.php:cExportarExcelEstadisticasAltasBajasProvPres(),

LLAMA: vistas/presidente/formExportarExcelEstadisticasAltasBajasProvPres.php
...
<h3 align="center">
    EXPORTAR ESTADÍSTICAS A EXCEL POR PROVINCIAS Y POR AÑOS CON LOS SIGUIENTES DATOS:
				<br /><br />
				Total de Alta (socias/os en alta a final de año),	ALTAS AÑO (Total,	H,	%H,	M,	%M), BAJAS AÑO (Total,	H,	%H,	M,	%M),	Altas Netas (por año)
</h3>


<!-- ** Inicio formExportarExcelEstadisticasAltasBajasProvPres(se podría pasar con parámetro) ** -->
<?php require_once './vistas/presidente/formExportarExcelEstadisticasAltasBajasProvPres.php'; ?>
...
<!-- ************ Fin vCuerpoExportarExcelEstadisticasAltasBajasProvPres.php ****************** -->