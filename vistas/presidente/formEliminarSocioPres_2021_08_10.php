<?php
/*-----------------------------------------------------------------------------
FICHERO: formEliminarSocioPres.php	
VERSION: PHP 7.3.21

DESCRIPCION: Es el formulario para eliminar los datos de de un socio, por un gestor con rol Presidente
             Previamente muestra algunos campos de datos y se puede introducir un comentario
													...
													En caso de que hubiese un archivo con la firma de un socio debido a alta por gestor, 
													también mostraría aquí para eliminaría el archivo del servidor.

LLAMADA: vistas/presidente/vCuerpoEliminarSocioPres.php
...
<div id="registro">
 ...
 <!--<div id="formLinea">-->
  ...
  <form method="post" class="linea" action="./index.php?controlador=cPresidente&amp;accion=eliminarSocioPres"	
		     	onSubmit="return confirm('¿Dar de baja al socio/a')">			
	 ...
	 <!-- ******************* Inicio Datos de CODUSER y CODSOCIO ****************************** -->
    <input type="hidden"
         	id="codUser"
   ...
   />			
 	 ...
 	 <!-- ******************* Fin Datos de CODUSER y CODSOCIO ****************************** -->
	    ...
	    />	 
					...
					<input type="text" readonly
												...
												value='<?php if (isset($datSocio['valoresCampos']['datosFormMiembro']['FECHANAC']['valorCampo']) 
													                && $datSocio['valoresCampos']['datosFormMiembro']['FECHANAC']['valorCampo'] !== "0000-00-00"  
																												)
...
<!--		
  <form method="post" class="linea"
      action="./index.php?controlador=cPresidente&amp;accion=eliminarSocioPres">		
