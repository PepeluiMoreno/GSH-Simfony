...
function cambiaVisibilidad(valor) 
{
 ...
 <form name="registrarSocio" method="post" action="./index.php?controlador=cPresidente&amp;accion=altaSocioPorGestorPres" enctype="multipart/form-data">	
  <br />		
	 ...
	 <fieldset>
	  <legend><strong>Datos de la cuota anual del socio/a</strong></legend>
	    ...
	    /><label><strong>Parado/a o dificultades enconómicas&nbsp;(mínimo <?php echo ceil($datosSocio['datosFormCuotaSocio']['IMPORTECUOTAANIOELParado']['valorCampo']).' €)'; ?></strong></label>
	           ...
	           ?>
	    />
					<label><strong>Honorario/a&nbsp;( <?php echo ceil($datosSocio['datosFormCuotaSocio']['IMPORTECUOTAANIOELHonorario']['valorCampo']).' € obligatorio) '; ?></strong></label>
  ...
  <div align="center">
    <input type="submit" name="siGuardarDatosSocio" value="Realizar el alta" class="enviar" />
	  	&nbsp;		&nbsp;		&nbsp;
		 <input type="submit" name="noGuardarDatosSocio" 
		        onClick="return confirm('¿Salir sin realizar el alta?')"
