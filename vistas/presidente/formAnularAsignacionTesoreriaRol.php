<?php
/*----------------------------------------------------------------------------------------------------														
FICHERO: formAnularAsignacionTesoreriaRol.php
VERSION: PHP 7.3.21
...
LLAMA: cPresidente.php:eliminarAsignacionTesoreriaRol()
...
<div id="registro">
 ...
 <span class="textoAzu112Left2">
	  Este socio/a tiene asignado el rol de Tesorería
  </span>
  <br /> <br />
		
 <div id="formLinea">
		
		<!-- ******************* Inicio Form para eliminar rol de Tesoreria ************* -->

  <form method="post" class="linea" action="./index.php?controlador=cPresidente&amp;accion=eliminarAsignacionTesoreriaRol"
	       onSubmit="return confirm('¿Eliminar asignación del rol Tesorería?')">								
  ...
  <input type="submit" name="SiEliminar" value="Eliminar asignación de rol Tesorería" class="enviar">				

 </form>
	<!-- ******************* Fin Form para eliminar rol de Tesoreria ****************** -->
