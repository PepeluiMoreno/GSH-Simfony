<?php
/*--------------------------------------------------------------------------------------------------
FICHERO: formAsignarPresiRolBuscar.php
PROYECTO: EL
VERSION: PHP 7.3.21
...
para ver si ya tiene rol de Presidencia que lo comparten (presidente/a, vice. y el secretario/a).
Según la situación se podrá después se podrá asignar/eliminar rol de Presidencia

Tiene tres botones para "Buscar por apellidos", "Buscar por email", y para "Cancelar"

LLAMADA: vistas/presidente/vCuerpoAsignarPresiRolBuscar.php
...
<br />	
				 ...
				 <form method="post" action="./index.php?controlador=cPresidente&accion=mostrarListaPresidenciaRol">
					      <input type="submit" name="mostrarListaresidenciaRol" value="Lista de socios/as con rol Presidencia">
	    </form>					
			
    </div>
<br />				
	<span class="textoAzul8Left">
 El presidente/a, vice. y el secretario/a, pueden asignar o anular el rol de Presidencia (es el mismo para presidente/a, vice. y el secretario/a)
		a un socios/a de EL				
<br /><br />	
Primero hay que buscar al socio/a para después hacer la operación de asignar-anular el rol de Presidencia
	 			<br /><br />
 ...
 <!-- ********************* Inicio  mensaje error *************** -->
  <br /><br /><br />
	...
	<!-- *************** Inicio form búsqueda por APE1, APE2 ************* -->	
		<form method="post" action="./index.php?controlador=cPresidente&amp;accion=asignarPresidenciaRolBuscar">
	  <fieldset>
 ...
 <!-- *************** Inicio form búsqueda 'EMAIL' ******************** -->	
	  ...
	  <fieldset>
		...
		<!--			 <input type="submit" name="NoAsignar" value="No asignar rol Presidencia" class="enviar"> -->					
	 </fieldset>	
 </form>					
