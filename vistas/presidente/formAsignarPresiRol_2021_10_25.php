<?php
/*--------------------------------------------------------------------------------------------------
FICHERO: formAsignarPresiRol.php
PROYECTO: EL
VERSION: PHP 7.3.21
...
LLAMADA: vistas/presidente/vCuerpoAsignarPresiRol.php
y previamente desde  cPresidente.php:asignarPresidenciaRolBuscar(), asignarPresidenciaRol()
...
<div id="registro">
 ...
 <div id="formLinea">
  ...
  <form method="post" class="linea" action="./index.php?controlador=cPresidente&amp;accion=asignarPresidenciaRol"	
			     onSubmit="return confirm('¿Asignar rol de Presidencia?')">			
...
?></textarea> 			 
	 ...
	 <!-- ******************* Fin Datos de identificación Socio ************** --> 	 		
	  ...
	  <input type="submit" name="SiAsignar" value="Asignar rol de Presidencia" class="enviar">	
  </form>

  <form method="post" class="linea" action="./index.php?controlador=cPresidente&amp;accion=asignarPresidenciaRol">		
   <input type="submit" name="NoAsignar" value="Cancelar asignar rol de Presidencia" class="enviar">
  </form>					
