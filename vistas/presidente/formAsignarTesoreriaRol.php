<?php
/*--------------------------------------------------------------------------------------------------
FICHERO: formAsignarTesoreriaRol.php
PROYECTO: EL
VERSION: PHP 7.3.21
...
LLAMADA: vistas/presidente/vCuerpoAsignarTesoreriaRol.php
...
<div id="registro">
 ...
 <div id="formLinea">
  ...
  <form method="post" class="linea" action="./index.php?controlador=cPresidente&amp;accion=asignarTesoreriaRol"	
			     onSubmit="return confirm('¿Asignar rol de Tesorería?')">			
...
?></textarea> 			 
	 ...
	 <!-- ******************* Fin Datos de identificación Socio ************** --> 	 		
	  ...
	  <input type="submit" name="SiAsignar" value="Asignar rol de Tesorería" class="enviar">	
  </form>

  <form method="post" class="linea" action="./index.php?controlador=cPresidente&amp;accion=asignarTesoreriaRol">		
   <input type="submit" name="NoAsignar" value="Cancelar asignar rol de Tesorería" class="enviar">
  </form>					
