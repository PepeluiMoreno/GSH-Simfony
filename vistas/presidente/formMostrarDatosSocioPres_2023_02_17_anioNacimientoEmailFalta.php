...
2023-01-22: Caambio fecha de nacimiento completa por sólo "año de nacimiento" 
----------------------------------------------------------------------------------------------------*/
?>
...
<div id="registro">
 ...
 <br />		
	...
	<span class="textoAzu112Left2">
	 <b>Datos de las cuotas del socio/a</b>
	</span> 
	<br />
     ...
     <tr bgcolor="#CCCCCC">
      ...
      <th  class="textoAzul8L">Tipo<br />cuota</th>						
						<th  class="textoAzul8L">Cuota<br /> EL</th>
      <th  class="textoAzul8L">Cuota<br/>elegida</th>  
     ...
     <?php					 
      ...
      //foreach ($datCuotas as $ordinal => $fila)
   	  ...
   	  {echo ("<tr height='25' bgcolor='#eeeded'>"); 
							...
							echo ("<td class='textoAzul7L'>".$fila['NOMAGRUPACION']['valorCampo']."</td>");
							echo ("<td class='textoAzul7L'>".$fila['CODCUOTA']['valorCampo']."</td>");
 
							echo ("<td class='textoAzul8Right'>".number_format($fila['IMPORTECUOTAANIOEL']['valorCampo'],0,",",".")."</td>");
       ...
       if ($saldo< 0)							
						 ...
						 { echo ("<td class='textoRojo7Left'>".$fila['ESTADOCUOTA']['valorCampo']."</td>");	
							}
						 else 
						 { echo ("<td class='textoAzul7L'>".$fila['ESTADOCUOTA']['valorCampo']."</td>");	
							}									
					
				   if (isset($fila['MODOINGRESO']['valorCampo']) && !empty($fila['MODOINGRESO']['valorCampo']))
       { echo ("<td class='textoAzul7L'>".$fila['MODOINGRESO']['valorCampo']."</td>");
							}
						 else
