<?php
/*--------------------------------------------------------------------------------------------------
FICHERO: formMostrarListaPresiRol.php
PROYECTO: EL
VERSION: PHP 7.3.21
...
LLAMADA: vistas/presidente/vCuerpoMostrarListaPresiRol.php
...
<div id="registro">
 ...
 <br />
	...
	- En la lista está incluidas socias/os con  el rol de Presidencia que incluye (Presidencia, Vice, Secretaría)
	</span>
	<br /> 	<br /> 
   ...
   <tr>
    ...
    <table width="100%" border="1" cellspacing="0" cellpadding="0" bordercolor="#99CCFF">
     ...
     <?php 				
					...
					$items = $datosSociosPresidenciaRol['resultadoFilas'];
