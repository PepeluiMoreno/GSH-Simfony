<?php
/*--------------------------------------------------------------------------------------------------
FICHERO: formExportarExcelEstadisticasAltasBajasProvPres.php
PROYECTO: EL
VERSION: PHP 7.3.21
...
LLAMADA: vistas/presidente/vCuerpoExportarExcelEstadisticasAltasBajasProvPres.php
y previamente desde  cPresidente.php:cExportarExcelEstadisticasAltasBajasProvPres(),
...
<div id="registro">	
  ...
  Después de hacer clic en "Exportar selección" es mejor elegir "Gardar archivo" 
		...
		<div align="left"> 		
<!-- ********************* Inicio selección provincia y año *************** -->						
<!--	<div align="center"> -->
		 <form method="post" 
         action="./index.php?controlador=cPresidente&amp;accion=cExportarExcelEstadisticasAltasBajasProvPres">
				<fieldset>
	    <p>		
      <br />					
					 <label>Provincia elegida (se puede elegir una o todas )</label>					
					 <?php 
					  require_once './modelos/libs/comboLista.php';
							
							//echo "<br><br>1 formExportarExcelEstadisticasAltasBajasProvPres.php:parValorComboProvSocios: ";print_r($parValorComboProvSocios);		
						
							echo comboLista($parValorComboProvSocios['lista'], "exportarCampo[CODPROV]",
						        	        $parValorComboProvSocios['valorDefecto'],
																							$parValorComboProvSocios['lista'][$parValorComboProvSocios['valorDefecto']],"","");																								
		     ?> 	
						<br /><br /><br />	
