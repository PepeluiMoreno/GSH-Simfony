<?php
/*--------------------------------------------------------------------------------------------------
FICHERO: formAltaSocioPorGestorCoord.php
...
LLAMADA: Es incluida desde "vCuerpoAltaSocioPorGestorCoord.php"  

OBSERVACIONES: Solo se diferencia de formAltaSocioPorGestorPres.php, y formAltaSocioPorGestorTes.php 
en que en esta no e puede dar de alta a socios honorarios y en el link, y algún fragmento de texto
...
function cambiaVisibilidad(valor) 
{
 ...
 <form name="registrarSocio" method="post"
       action="./index.php?controlador=cCoordinador&amp;accion=altaSocioPorGestorCoord" enctype="multipart/form-data">	
  <br />		
  ...
  <!-- ************************ INICIO INTRODUCIR EMAIL (se oculta y activa si tiene o no email) ******************* -->
   ...
   <!-- ************************ Inicio  Subir al servidor el Archivo de alta ************************************** -->	
  	<fieldset>			 				
       ...
       <br />					
     <p>
		     <!-- Para los siguientes HIDDEN los valores podrían venir desde cCoordinador.php:altaSocioPorGestorCoord() -->		
	 ...
	 <fieldset>
	  <legend><strong>Datos de la cuota del socio/a</strong></legend>
	    ...
	    <input type="radio"
	           ...
	           {  echo " checked";}
	           ?>
	    /><label><strong>Parado/a o dificultades enconómicas&nbsp;(mínimo <?php echo ceil($datosSocio['datosFormCuotaSocio']['IMPORTECUOTAANIOELParado']['valorCampo']).' €)'; ?></strong></label>
		  <br /><br />
				
				<span class="comentario11"> 
					Anota la cantidad elegida por la socia/o, igual o superior a la indicada a la indicada en el tipo de cuota correspondiente, (el socio/a puede elegir una cantidad superior en concepto de cuota + donación)
		  </span>	
				<br />	<br />  				
  ...
  <!-- ************************ Inicio Agrupación territorial ****************************************************** -->		
	 ...
	 <p>
		...
		class="textoAzul8Left" name="datosFormMiembro[OBSERVACIONES]" rows="7" cols="80"><?php 
  ...
  <br />
		<!-- ************************ Inicio Botones de formAltaSocioPorGestorCoord ************************************** -->  
  ...
  <div align="center">
    <input type="submit" name="siGuardarDatosSocio" value="Alta del socio/a" class="enviar" />
		...
		<!-- ************************ Fin Botones de formAltaSocioPorGestorCoord ***************************************** -->  		
			<br />
...
<!-- ********** Fin del formulario formAltaSocioPorGestorCoord ************* -->		
