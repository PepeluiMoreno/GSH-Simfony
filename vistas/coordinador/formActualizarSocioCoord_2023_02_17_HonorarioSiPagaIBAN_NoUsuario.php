     ...
     */ 					
			...
			{ 											
					echo "<br /><br /><label>NOTA: En el año <strong>".$datSocio['campoActualizar']['datosFormCuotaSocio']['ANIOCUOTA']['valorCampo'].
										...
										" \"</strong> le corresponde pagar una cuota igual o superior a <strong>\" ". 
										ceil($datSocio['campoActualizar']['datosFormCuotaSocio']['IMPORTECUOTAANIOEL']['valorCampo']). 
										" € \"</strong> , pero si quiere voluntariamente puede pagar una cuota anual superior o hacer una donación.</label>";											
					?>				
     ...
     <!-- Cuando se ponga pago para honorarios lo siguiente podría ser común y al final de los dos -->
					<span class="comentario11">
					<strong>Elegir nuevos valores de la cuota voluntaria para el año <?php echo $datSocio['campoActualizar']['datosFormCuotaSocio']['ANIOCUOTA']['valorCampo']?>
					</strong>(también se pueden dejar sin modificar).
					</span>						
					<br />
					
					<span class="comentario11">
					Si en el presente año ya estuviese pagada su cuota, se anotará como su nueva cuota elegida para el próximo año.
					</span>								
					<br /><br />	
					<span class="comentario11"><strong> Modificar su Cuota total para el año 
     ...
     <!-- ***** Inicio Descomentar para activar IBAN para Honorario -->
				<fieldset>	  
						<legend><strong>Cuenta bancaria para el cobro de su cuota anual voluntaria</strong></legend>
						<p>
							...
							<?php 
								...
								{  
										echo "<span class='comentario11'>		Si hubiese cambiado su cuenta bancaria escribe la nueva cuenta </span>"; 
								}
								else
								{
										echo "<span class='comentario11'> Ahora puedes domiciliar el pago de su cuota anual voluntaria</span>";						
								}			
							?>				
							<br /><br />		
							<label>Su cuenta <strong>IBAN</strong> (dos letras de país + número sin puntos ni guiones)</label> 
								<input type="text"
							...
							<span class="comentario11">
								- La fecha de cobro se lo comunicaremos con antelación por correo electrónico		
							<br /><br />										
								- También puede pagar su cuota por transferencia, ingreso o mediante PayPal en las cuentas de de Europa Laica en la opción del menú:
