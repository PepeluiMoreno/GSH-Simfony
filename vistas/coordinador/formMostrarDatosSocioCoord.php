<?php
/*----------------------------------------------------------------------------------------------------
FICHERO: formMostrarDatosSocioCoord.php

VERSION: PHP 7.3.21

DESCRIPCION: Contiene menú idz de "Secciones" y el formulario para mostrar los datos de de un 
socio al coordinador. Muestra si lo hubiese el archivo con la firma del socio 
													
LLAMADA: vistas/coordinador/vCuerpoMostrarDatosSocioCoord.php 
y a su vez desde cCoordinador.php:mostrarDatosSocioCoord(), en lista de socios desde el icono Ver = Lupa

OBSERVACIONES:
2022-12-15 : suprimido COLABORA a petición presidencia, 
 ...
 <br />		
	...
	<br />
     ...
     <?php					 
						...
						//$datCuotas = $datosSocio['datosFormCuotaSocio'];
						$datCuotas = array_reverse($datosSocio['datosFormCuotaSocio']);
