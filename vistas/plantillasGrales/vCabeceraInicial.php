...
DESCRIPCION: Escribe la cabecera inicial de entrada a la aplicación con los logos y la barra 
             horizontal que está debajo con los links: Entrar, Nuevo socio, Recordar contraseña y Salir
...
<body>
	<div class="container-fluid"><!-- Afecta toda la pág. se cierra en pie de pág. -->
		...
		<!-- ******* Inicio barra horizontal enlaces registrase, contraseña, ...***** -->
		<nav class="navbar navbar-default">
				...
				<div class="collapse navbar-collapse" id="menu-principal">
						<ul class="nav navbar-nav navbar-right">
								...
								<li><a href="./index.php?controlador=controladorLogin&amp;accion=validarLogin"><b>ACCESO SOCIOS/AS</b></a></li>
								<li><a href="./index.php?controlador=controladorSocios&amp;accion=altaSocio"><b>ASÓCIATE</b></a></li>								
								<li><a href="./index.php?controlador=controladorLogin&amp;accion=recordarLogin"><b>Recordar usuario y contraseña</b>&nbsp;&nbsp;</a></li>
								<li><a href="./index.php?controlador=controladorLogin&amp;accion=logOut"><b>Salir</b></a></li>
						</ul>
				</div><!-- /.navbar-collapse -->
		</nav>
		<!-- *********Fin barra horizontal enlaces registrase, contraseña, ...********* -->
